 ...
 * Each {@code GroupedExecutor} also maintains some basic
 ...
 *
 * <dd>A {@code GroupedExecutor} will automatically adjust the
 ...
 * invokes the {@link
 * RejectedExecutionHandler#rejectedExecution(Runnable, GroupedExecutor)}
 * method of its {@link RejectedExecutionHandler}.  Four predefined handler
 * policies are provided:
 *
 * <ol>
 *
 * <li>In the default {@link GroupedExecutor.AbortPolicy}, the handler
 * throws a runtime {@link RejectedExecutionException} upon rejection.
 *
 * <li>In {@link GroupedExecutor.CallerRunsPolicy}, the thread
 * that invokes {@code execute} itself runs the task. This provides a
 * simple feedback control mechanism that will slow down the rate that
 * new tasks are submitted.
 *
 * <li>In {@link GroupedExecutor.DiscardPolicy}, a task that cannot
 ...
 *
 * <li>In {@link GroupedExecutor.DiscardOldestPolicy}, if the
 ...
 * GroupedExecutor.DiscardOldestPolicy} documentation.
 *
 * </ol>
 *
 ...
 *
 * <pre> {@code
 * class PausableGroupedExecutor extends GroupedExecutor {
 *   private boolean isPaused;
 *   private ReentrantLock pauseLock = new ReentrantLock();
 *   private Condition unpaused = pauseLock.newCondition();
 *
 *   public PausableGroupedExecutor(...) { super(...); }
 *
...
public class GroupedExecutor extends java.util.concurrent.AbstractExecutorService {
     ...
     * allow access from ScheduledGroupedExecutor.
     */
     ...
     * ScheduledGroupedExecutor
     */

    /**
     * Invokes the rejected execution handler for the given command.
     * Package-protected for use by ScheduledGroupedExecutor.
     */
     ...
     * ScheduledGroupedExecutor to cancel delayed tasks.
     */
    void onShutdown() {
    }
...
//                System.err.println(w.completedTasks);
    ...
    /**
     * Creates a new {@code GroupedExecutor} with the given initial
     * parameters, the
     * {@linkplain Executors#defaultThreadFactory default thread factory}
     * and the {@linkplain GroupedExecutor.AbortPolicy
     ...
     */
    public GroupedExecutor(int corePoolSize,
                              int maximumPoolSize,
                              long keepAliveTime,
                              TimeUnit unit,
    ...
    /**
     * Creates a new {@code GroupedExecutor} with the given initial
     * parameters and the {@linkplain GroupedExecutor.AbortPolicy
     * default rejected execution handler}.
     *
     * @param corePoolSize the number of threads to keep in the pool, even
     *        if they are idle, unless {@code allowCoreThreadTimeOut} is set
    ...
    public void shutdown() {
        ...
        try {
            ...
            onShutdown(); // hook for ScheduledGroupedExecutor
        } finally {
            mainLock.unlock();
        }
        tryTerminate();
    ...
    /** Used by ScheduledGroupedExecutor. */
    boolean isStopped() {
     ...
     * {@link GroupedFutureTask}) either explicitly or via methods such as
     ...
     *
     * <pre> {@code
     * class ExtendedExecutor extends GroupedExecutor {
     *   // ...
    ...
    public interface RejectedExecutionHandler {
        /**
         * Method that may be invoked by a {@link GroupedExecutor} when
         * {@link GroupedExecutor#execute execute} cannot accept a
         ...
         */
        void rejectedExecution(Runnable r, GroupedExecutor executor);
    }
     ...
     *
     * This is the default handler for {@link GroupedExecutor} and
     * {@link ScheduledGroupedExecutor}.
     */
    public static class AbortPolicy implements RejectedExecutionHandler {
         ...
         */
        public void rejectedExecution(Runnable r, GroupedExecutor e) {
...
//    	System.err.println(this);
    ...
    public class GroupedFutureTask<V> extends FutureTask<V> implements Runnable {
